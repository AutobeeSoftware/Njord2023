...
class TakePhoto:
    ...
    def lidar_callback(self, length):
        front_left = list(length.ranges[0:9])
        front_right = list(length.ranges[350:359])
        back.left = list(length.ranges[170:179])
        back.right = list(length.ranges[180:189])
        right = list(length.ranges[260:280])
        left = list(length.ranges[80:100])
